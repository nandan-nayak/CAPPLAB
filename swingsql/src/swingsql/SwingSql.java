...
class Update extends JFrame implements ActionListener
{
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(s.equals("Done"))
		{
			...
			SwingSql.b.updateData(Integer.parseInt(t1.getText()),Integer.parseInt(t2.getText()));
 ...
 class Insert extends JFrame implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(s.equals("Done"))
		{
			...
			SwingSql.b.insertData(t1.getText(),t2.getText() ,Integer.parseInt(t4.getText()), t3.getText(),Integer.parseInt(t5.getText()));
...
public class SwingSql extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
		...
		SwingSql s=new SwingSql(); 
		 ...
		 String DB_URL = "jdbc:mysql://localhost:3306/java1?autoReconnect=true&useSSL=false";
